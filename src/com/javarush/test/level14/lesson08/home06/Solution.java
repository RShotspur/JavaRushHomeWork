...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        while (true){
            ...
            if (movie.equals("cartoon")){
                mainMovie = new Cartoon();
                System.out.println(mainMovie.getClass().getSimpleName());
            }
            else if (movie.equals("thriller")){
                mainMovie = new Thriller();
                System.out.println(mainMovie.getClass().getSimpleName());
            }
            else if (movie.equals("soapOpera")){
                mainMovie = new SoapOpera();
                System.out.println(mainMovie.getClass().getSimpleName());
            } else {
                break;
            }
